...
public final class Strings {
    ...
    public static Object deductInstance(String value) {
        ...
        if(value != null) {
            ...
            if (trimmedStringValue.equalsIgnoreCase(NULL)) {
                result = null;
            } else if (trimmedStringValue.equalsIgnoreCase(TRUE)) {
                result = true;
            } else if (trimmedStringValue.equalsIgnoreCase(FALSE)) {
                result = false;
            } else if (trimmedStringValue.startsWith(RICH_TEXT_SEPARATOR) &&
                    trimmedStringValue.endsWith(RICH_TEXT_SEPARATOR)) {
