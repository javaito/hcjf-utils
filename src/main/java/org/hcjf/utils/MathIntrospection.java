 ...
 * create the static introspection of {@link Math} class
 * @author javaito.
 */
public class MathIntrospection {
    ...
    /**
     * This method invokes the specific method of the {@link Math} class
    ...
    /**
     * Returns all the methods cached fot the {@link Math} class
     * @return Methods set.
     */
    ...
    /**
     * This invoker implementation represents each static method in the {@link Math} class
     */
    ...
    /**
     * Invoker filter to create the introspection cache for the {@link Math} class
     */
    private static class MathInvokerFilter implements Introspection.InvokerFilter<MathInvoker> {
        ...
        /**
         * If the method is implemented into the {@link Math} class and this
